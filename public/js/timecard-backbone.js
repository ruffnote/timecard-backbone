(function() {
  ...
  this.JSRelModel = (function(_super) {
    ...
    JSRelModel.prototype.find = function(id) {
      ...
      return new this.thisclass(data);
    };
...
(function() {
  ...
  this.WorkLog = (function(_super) {
    ...
    WorkLog.prototype.thisclass = function(params) {
...
(function() {
  ...
  this.AddIssueView = (function(_super) {
    ...
    AddIssueView.prototype.template = _.template($('#add_issue-template').html());
...
(function() {
  ...
  this.WorkLogView = (function(_super) {
    ...
    WorkLogView.prototype.template = _.template($("#work_log-template").html());

    WorkLogView.prototype.render = function() {
      var data, template, work_log;
